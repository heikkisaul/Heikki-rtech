...
if("FALSE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/tudeng/Heikki-rtech/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/tudeng/Heikki-rtech/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/tudeng/Heikki-rtech/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Heikki <hsaul@ut.ee>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tudeng/Heikki-rtech/install/${idir}'.  Ask the maintainer 'Heikki <hsaul@ut.ee>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tudeng/Heikki-rtech/install/lib;/home/tudeng/Heikki-rtech/devel/lib;/opt/ros/indigo/lib)
